...
class ProductInfo extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  buildColorBox(defaultSize, Color(0xFF7BA275), isActive: true),
                  buildColorBox(defaultSize, Color(0xFFD7D7D7)),
                  buildColorBox(defaultSize, kTextColor),
                ],
              )
            ]),
      ),
  ...
  Container buildColorBox(double defaultSize, Color color,
      {bool isActive = false}) {
    return Container(
